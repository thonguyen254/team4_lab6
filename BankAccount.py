...
class BankAccount:
    ...
    # functions.  This is a peculiarity of Python.  Just
    # get used to it.  When you call the function the "self"
    ...
    def __del__(self):
        ...
        # of the class, in this case "BankAccount"
    ...
    def withdraw(self, amount):
        if amount > self.__balance:
            ...
            # Exception class
            raise Exception("Amount to withdraw cannot be greater than balance")
        self.__balance -= amount
