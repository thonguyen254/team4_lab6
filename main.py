...
# and calls the correct "withdraw()" method on that object, regardless of what
# type of object it is.  Remember that in Python the account object
# has a type, but it's not explicitly declared.  Rather the type is
